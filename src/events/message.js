...
client.on('message', (msg) => {
  (async () => {
    ...
    if (result.success === false) {
      ...
      await Logger.log('Unsuccessful command result: ' + msg.id + ' User: ' + msg.author.tag + ' User ID: ' + msg.author.id + ' Guild: ' + msg.guild.name + ' Content ' + msg.content + ' | Reason: ' + result.errorReason, 'DEBUG');

      return msg.tryCreateErrorReply(message);
    }

    return Logger.log('Successful command result: ' + msg.id + ' User: ' + msg.author.tag + ' User ID: ' + msg.author.id + ' Guild: ' + msg.guild.name + ' Content ' + msg.content, 'DEBUG');
  })()
